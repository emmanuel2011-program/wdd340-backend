...
/* **************************************
* Building my classification view HTML
* ************************************ */
  ...
  if (data.length > 0) {
    ...
    data.forEach((vehicle) => {
      ...
      grid +=
        ...
        vehicle.inv_thumbnail.replace('/images/', '') +
        '" alt="Image of ' +
        vehicle.inv_make +
        " " +
        vehicle.inv_model +
...
/* **************************************
 * Building a single listing element from data allowing vehicles to be displayed 
 */
  ...
  if (data) {
    listingHTML = `
      <section class="car-listing">
        <img src="/images/vehicles/${data.inv_image.replace('/images/', '')}" alt="${data.inv_make} ${data.inv_model}">
...
/**
 * Build an html table string from the message array week 6
